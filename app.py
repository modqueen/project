...
with gr.Blocks(title="🔊",theme=gr.themes.Base(primary_hue="rose", neutral_hue="zinc")) as app:
    ...
    with gr.Tabs():
        with gr.TabItem(i18n("Make your Character sing! 🎤🎵")):
            with gr.Row():
        ...
        with gr.TabItem("Download Model"):
            with gr.Row():
                url=gr.Textbox(label="Enter the Google Drive URL to the Voice Model:")
            with gr.Row():
            ...
            with gr.Row():
                gr.Markdown(
                """
                ✨ An AI Voice Training Platform for the fandom made simpler, more secure, and user-friendly ✨ \n
                Forked from the original RVC project https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI \n
                """
                )
        with gr.TabItem(i18n("Create Voice Models here 🤖")):
            with gr.Row():
                with gr.Column():
                ...
                with gr.Column():
                    f0method8 = gr.Radio(
                        label=i18n(
                            "Select the pitch extraction algorithm: \n when inputting singing, you can use pm for high-quality speech but poor CPU, \n use dio to speed up, \n harvest has better quality but is slower, \n rmvpe has the best effect and consumes less CPU/GPU"
                        ),
